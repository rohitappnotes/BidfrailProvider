...
public abstract class AsyncTaskAdvancedAlternative<INPUT, PROGRESS, OUTPUT> {
    private boolean cancelled = false;
    private Future<OUTPUT> outputFuture;

    public AsyncTaskAdvancedAlternative() {
    }

    /**
     * @see #execute(Object)
     */
    public AsyncTaskAdvancedAlternative<INPUT, PROGRESS, OUTPUT> execute() {
        return execute(null);
    }
     ...
     */
    public AsyncTaskAdvancedAlternative<INPUT, PROGRESS, OUTPUT> execute(final INPUT input) {
        onPreExecute();
