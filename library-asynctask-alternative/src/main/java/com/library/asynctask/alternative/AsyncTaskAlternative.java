...
public abstract class AsyncTaskAlternative<INPUT, PROGRESS, OUTPUT> {
    private boolean cancelled = false;

    public AsyncTaskAlternative() {
     ...
     * @see #execute(Object)
     */
    public AsyncTaskAlternative<INPUT, PROGRESS, OUTPUT> execute() {
        return execute(null);
    }
     ...
     */
    public AsyncTaskAlternative<INPUT, PROGRESS, OUTPUT> execute(final INPUT input) {
        onPreExecute();
