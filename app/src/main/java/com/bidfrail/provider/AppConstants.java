...
public class AppConstants {
    ...
    public static final class AppConfig {
        public static final String APP_NAME                 = "BidFrailProvider";
    ...
    public static final class AppSupport {
        ...
        public static final String MOBILE                   = "918588832388";
    ...
    public static final class Delay {
        ...
        public static final int SUCCESS                         = 1000 * 3;
        public static final int SHIMMER                         = 500;
    }
    ...
    public static final class Screen {
        ...
        public static final class Key {
            public static final String KYE_NAVIGATE_TO                = "navigate_to";

            public static final String KYE_TITLE                      = "title";
            public static final String KYE_MESSAGE                    = "message";
            public static final String KYE_ORDER_TYPE                 = "order_type";
            public static final String KYE_ORDER_ID                   = "order_id";
            public static final String KYE_DATA_REQUIRED              = "data_required";
        }
        ...
        public static final class Extras {
            ...
            public static final String EXTRA_DATA_REQUIRED              = "DATA_REQUIRED";
        }
    }
