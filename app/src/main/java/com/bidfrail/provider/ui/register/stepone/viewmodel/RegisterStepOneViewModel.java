package com.bidfrail.provider.ui.register.stepone.viewmodel;
...
public class RegisterStepOneViewModel extends BaseViewModel {
    ...
    @Inject
    public RegisterStepOneViewModel(LocalRepository localRepository, RemoteRepository remoteRepository) {
