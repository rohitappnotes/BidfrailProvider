package com.bidfrail.provider.data.remote.glide;
...
public class GlideImageLoader {
    ...
    public static void load(Context context, String url, ImageView imageView, GlideImageLoadingListener glideImageLoadingListener) {
        Glide.with(context)
                .load(url).override(Target.SIZE_ORIGINAL, Target.SIZE_ORIGINAL)
                .fitCenter()
                .listener(new RequestListener<Drawable>() {
